...
- Use \`gallery\` for compact screenshot or image review: \`{ title?, columns?, items: [{ src, alt, caption?, detail?, findings? }] }\` in YAML or JSON. Tiles can place a list of findings directly below each thumbnail and open the full image with its description in a keyboard-navigable preview.
